...
describe('Improved register', ()=> {
    ...
    // let correctFirstName = 'Petar';
    // let correctLastName = 'Petrovic';
    // let correctRegisterEmail = 'petar111@gmail.com';
    // let correctRegisterPassword= 'kisobran.22';
    // let correctPasswordConfirmation = 'kisobran.22';
    before('visit link', ()=>{
        cy.visit('/');
    });
